...
//         } else {
//             navigate(path); // Navigate to the private route
//         }
//     };
...
//                                     onClick={() => handlePrivateRoute('/add-campaign')}
//                                 >
//                                     Add New Campaign
//                                 </button>
//                             </li>
...
//                                 <button
//                                     className="btn btn-ghost"
//                                     onClick={() => handlePrivateRoute('/my-campaigns')}
//                                 >
//                                     My Campaigns
//                                 </button>
//                             </li>
...
//                                 <button
//                                     className="btn btn-ghost"
//                                     onClick={() => handlePrivateRoute('/my-donations')}
//                                 >
//                                     My Donations
//                                 </button>
//                             </li>
...
//                                 <button
//                                     onClick={toggleTheme}
//                                     className="btn btn-sm btn-ghost w-full flex justify-start items-center"
//                                 >
//                                     {theme === 'light' ? (
//                                         <>
//                                             <FaRegMoon className="mr-2 text-xl" />
//                                             Dark Mode
//                                         </>
//                                     ) : (
//                                         <>
//                                             <FaRegSun className="mr-2 text-xl" />
//                                             Light Mode
//                                         </>
//                                     )}
//                                 </button>
...
//                     <button
//                         onClick={toggleTheme}
//                         className="btn btn-sm btn-ghost hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 ease-in-out max-[1025px]:visible max-[1020px]:hidden"
//                     >
...
//                             >
//                                 <li>
//                                     <NavLink to="/profile" activeClassName="active" className="justify-between">
//                                         Profile
//                                     </NavLink>
//                                 </li>
//                                 <li>
        ...
        <div>
            <div className={`navbar ${theme === 'light' ? 'bg-white' : 'bg-base-900'} shadow`}>
                ...
                <div className="navbar-end flex items-center gap-4">
                    <button
                        onClick={toggleTheme}
                        className="btn btn-sm btn-ghost hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-300 ease-in-out"
                    >
                        {theme === 'light' ? <FaRegMoon className="text-xl" /> : <FaRegSun className="text-xl" />}
                    </button>
