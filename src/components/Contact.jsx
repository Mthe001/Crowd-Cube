...
//         Swal.fire({
//             title: 'Logged In!',
//             text: 'You are now logged in for demo purposes.',
//             icon: 'success',
...
//         Swal.fire({
//             title: 'Message Sent!',
//             text: 'Thank you for contacting us. This is a demo response.',
//             icon: 'success',
//             confirmButtonText: 'OK',
//             timer: 3000,
//         });
...
//                         className="btn btn-secondary text-white bg-blue-500 hover:bg-blue-600 px-6 py-2 rounded"
//                     >
//                         Login for Demo
//                     </button>
//                 )}
                ...
                <div className="w-full lg:w-2/3 bg-white dark:bg-zinc-800 rounded-lg shadow-md p-8">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="flex flex-col lg:flex-row gap-4">
                            <div className="form-control w-full">
                                ...
                                <input
                                    ...
                                    name="name"
                                    placeholder="Enter your name"
                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-zinc-600 bg-gray-200 dark:bg-zinc-950 focus:ring focus:ring-blue-300 focus:outline-none"
                                    required
                                />
                            </div>
                            <div className="form-control w-full">
                        ...
                        <div className="form-control mt-6">
                            <button
                                type="submit"
                                className="w-full py-3 text-white bg-blue-500 hover:bg-blue-600 rounded-lg shadow"
                            >
                                Send Message
                            </button>
                        </div>
